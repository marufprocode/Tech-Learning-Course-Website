...
const Profile = () => {
  ...
  return (
    <div className="container border min-h-screen mx-auto flex justify-center">
      <div className="border m-5 md:m-10 p-10 rounded-lg max-w-[900px] font-Paytone" style={{background:'radial-gradient(circle, rgba(174,238,189,1) 0%, rgba(148,187,233,1) 100%)'}}>
        ...
        <div className="grid grid-cols-12 mt-10">
          ...
          <div className="col-span-12 md:col-span-9 pl-0 md:pl-10 my-auto mt-5 md:mt-0">
            {/* <ProfileInfo /> */}
            {/* <ProfileEdit/> */}
            {
